...
<body>
	...
	<!-- <embed src="assets/docs/SUSUNAN_ORGANIGRAM_BEM_2019.pdf" width="800px" height="2100px"/> -->
	<embed src="assets/docs/SUSUNAN_ORGANIGRAM_BEM_2019.pdf#toolbar=0&navpanes=0&scrollbar=0" type="application/pdf" width="100%" height="600px" />	
	<!-- <iframe src="assets/docs/SUSUNAN_ORGANIGRAM_BEM_2019.pdf#toolbar=0&navpanes=0&scrollbar=0" style="max-width: 200% ; height: 600px;border: none;"></iframe> -->
	<?php footer_web();?>
	</div>
	</div>	
